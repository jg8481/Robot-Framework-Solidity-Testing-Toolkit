...
@test "Check the end-to-end behavior of the 'start-solidity-qa-workflows.sh' Bash script after it installs all of the required Solidity tools" {
    ...
    sleep 5
    cat "$CURRENT_PATH"/atest/acceptance-test-resources/tools-installer-runner.acceptance-test-log | grep "This command will install all of the required NodeJS packages"
}
